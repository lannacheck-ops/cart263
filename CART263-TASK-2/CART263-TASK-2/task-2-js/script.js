...
function setup() {
     ...
     * let lastImage = imageContainer[imageContainer.length - 1]
     * OR
     * imageContainer[imageContainer.length - 1].children[0].getAttribute("src")
     */
    let imageContainer = document.querySelectorAll(".img-container")
     ...
     * 5C: document.querySelector("h2").textContent
     */
