...
function setup_A() {
  ...
  function aniC(parentCanvas) {
    ...
    let handleDrop = function (event) {
      ...
      if (event.target.id === "lips") {//if our draggable obj is dropped over the HTML and CSS dropTarget then do this stuff
        ...
        const randomLeft = Math.floor(Math.random() * (parentCanvas.clientWidth - lips.offsetWidth));
        const randomTop = Math.floor(Math.random() * (parentCanvas.clientHeight - lips.offsetHeight));
