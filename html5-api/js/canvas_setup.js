window.onload = function () {
    ...
    //get the context to do all of the drawing. Each canvas has its own individual context(if you have multiple canvases).
    ...
    context.beginPath(); // in case you need two circles
    context.arc(xPos, yPos, radius, startAngle, endAngle, true);
    context.closePath(); // closes path in case you have two circles
    context.fill(); // set the fill after drawing the circle
